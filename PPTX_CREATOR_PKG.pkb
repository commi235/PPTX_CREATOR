...
AS
  ...
  */
  ...
  c_slide_id_offset CONSTANT NUMBER := 255;
  c_slide_relation_id_offset CONSTANT NUMBER := 6;
  ...
  */
  ...
  BEGIN
    ...
    RETURN sql_util_pkg.clob_to_blob(REPLACE(l_data.getClobVal, chr(10)));
  END update_content_types;

  -- Insert slide id tag into slide id list of presenation for each slide
  ...
  */
  ...
  BEGIN
    ...
    LOOP
      ...
      l_current_slide.slide_id := c_slide_id_offset + i;
      l_current_slide.relation_id := c_slide_relation_id_offset + i;
